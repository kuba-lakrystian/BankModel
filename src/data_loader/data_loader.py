...
class DataLoader:
    ...
    def train_test_load(self):
        ...
        self.data_train_raw[AGE] = pd.to_numeric(self.data_train_raw[AGE], errors='coerce')
        self.data_test_raw[AGE] = pd.to_numeric(self.data_test_raw[AGE], errors='coerce')
        self.data_train_raw[ANTIGUAEDAD] = pd.to_numeric(self.data_train_raw[ANTIGUAEDAD], errors='coerce')
        self.data_test_raw[ANTIGUAEDAD] = pd.to_numeric(self.data_test_raw[ANTIGUAEDAD], errors='coerce')
        self.data_train_raw[INDREL_1MES] = pd.to_numeric(self.data_train_raw[INDREL_1MES], errors='coerce')
        self.data_test_raw[INDREL_1MES] = pd.to_numeric(self.data_test_raw[INDREL_1MES], errors='coerce')
